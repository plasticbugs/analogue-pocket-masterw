Put masterw.rom here.

Build it from your own MAME `masterw` romset with the builder in the release
...
CRC32, and verifies the finished 1,638,400-byte image against a known md5, so
a wrong or damaged romset is reported rather than quietly built into
something that half works.

Already using pupdate or the standard `mra` tool? Point it at masterw.mra;
