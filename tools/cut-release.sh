...
for extra in masterw.mra archrivals.mra README.md tools/mra_build.py; do
...
VER=$(python3 -c "import json;print(json.load(open('pkg/pocket/Cores/plasticbugs.masterw/core.json'))['core']['metadata']['version'])")
